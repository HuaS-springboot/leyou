    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <div class="handle-box">
                <el-input v-model="select_word" placeholder="活动名称" class="handle-input mr10" ></el-input>
                <el-input v-model="select_word" placeholder="参与商品" class="handle-input mr10" ></el-input>
                <el-select v-model="value" placeholder="活动状态" class="mr10 handle-select">
                    <el-option
                ...
                <label class="mr10" style="color:#333;margin-left:20px;">活动时间</label>
                <div class="timeChoose mr10">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                <el-table-column prop="address" label="活动名称" >
                </el-table-column>
                ...
                <el-table-column prop="address" label="参与商品" >
                </el-table-column>
                <el-table-column prop="address" label="原价" >
                </el-table-column>
                <el-table-column prop="address" label="拼团价" >
                </el-table-column>
                <el-table-column prop="address" label="成团人数" >
                </el-table-column>
                <el-table-column prop="address" label="参与人数" >
                </el-table-column>
                <el-table-column prop="address" label="状态" >
                </el-table-column>
                <el-table-column label="操作" width="100" align="left" :formatter="formatter">
