        ...
        <div class="container">
            <el-tabs v-model="message">
                <el-tab-pane :label="`商品信息`" name="tab1" >
                    <el-form :model="goodsDetail" ref="goodsDetail" label-width="160px" label-position="left" class="addGoods1">
                        ...
                        <el-form-item label="商品分类" class="addGoodsType">
                            <el-cascader class="mr10" :options="typeList" :props="{ checkStrictly: true }" clearable placeholder="商品分类" @change="typeChange" ></el-cascader>
                        </el-form-item>
                        <el-form-item label="商品图片">
                            <div class="el-upload-list el-upload-list--picture-card uploadCom" v-show="bannerList.length>0">
                                <div tabindex="0" v-for="item in bannerList" :key="item" class="el-upload-list__item is-success">
                                    <div data-v-452ce00c="">
                                        ...
                                        <span data-v-452ce00c="" class="el-upload-list__item-actions">
                                            ...
                                            <span data-v-452ce00c="" class="el-upload-list__item-delete" >
                                                <i data-v-452ce00c="" class="el-icon-delete" @click="delBanner(item)"></i>
                                            </span>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <!-- <el-form-item label="是否上架">
                            <el-radio-group v-model="goodsDetail.publishStatus">
                ...
                <el-tab-pane :label="`首页推荐`" name="tab7" :disabled='tab7Abled'>
                    ...
                    <el-button  type="primary"  v-show="this.proCheck==true||this.bannerCheck==true">保存设置</el-button>
...
<script>
    ...
    import {getGoodsType,arrToObj,null2str} from '../../../common/common'
    export default {
        name: 'tabs',
        components: {
            //调用组件
        ...
        methods: {
            ...
            //删除banner图
            delBanner(file){
                let index=this.bannerList.indexOf(file)
            ...
            //banner图片上传
            bannerSuccess(file){
                this.bannerList.push(file.data.url)
            },
            //文件上传
            shareSuccess(file) {
            ...
            submitGoods(){
                ...
                this.goodsDetail.productImage=this.bannerList.join(',')
            ...
            submitTab4(){
                if(this.specsList.length==0){
                    ...
                    if(this.specsList[0].productPrice==""||this.specsList[0].productStock==0){
