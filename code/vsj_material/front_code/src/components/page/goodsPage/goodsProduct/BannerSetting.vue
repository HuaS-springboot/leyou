    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-calendar"></i> 轮播图设置</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="form-box">
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="40%" class="typeEdit">
            <el-form ref="form" :model="form" label-width="110px" label-position="left">
                <el-select v-model="value" placeholder="一级分类" class="mr10 ">
                    <el-option
                ...
                <!-- 二级分类-->
                <el-select v-model="value" placeholder="二级分类" class="mr10 ">
                    <el-option
                    v-for="item in options"
                    :key="item.value"
                    :label="item.label"
            ...
            return {
                ...
                list:[
                    ...
                    },
                    {
                        id: 2,
                        name: ' ',
                        color:{"background-color":"palevioletred"}
                    },
                    {
                        id: 3,
                        name: ' ',
