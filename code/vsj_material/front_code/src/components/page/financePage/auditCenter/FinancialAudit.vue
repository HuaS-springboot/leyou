    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <div class="handle-box">
                <el-input v-model="select_word" placeholder="姓名" class="handle-input mr10" ></el-input>
                <el-select v-model="value" placeholder="会员等级" class="mr10 handle-select">
                    <el-option
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                <el-table-column prop="address" label="会员名称" >
                </el-table-column>
                
                
                <el-table-column prop="address" label="会员等级" >
                </el-table-column>
                <el-table-column prop="address" label="提现金额">
                </el-table-column>
