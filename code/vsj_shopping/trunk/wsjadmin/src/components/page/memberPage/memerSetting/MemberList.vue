    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <div class="handle-box">
                ...
                <el-input v-model="parentName" placeholder="推荐人名称" class="handle-input mr10" ></el-input>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="parentName" label="推荐人" >
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getMemberList(){
                ...
                axiosRequest(this.$URL.QUERY_MEMBER_LIST,selectForm,'POST').then((res)=>{
            ...
            exportList(){
                if(this.total==0){
                    ...
                    window.location.href=request.SERVER+this.$URL.EXPORT_MEMBER_LIST+'?nickName='
                                                    +this.nickName+'&parentName='+this.parentName+'&telPhone='
