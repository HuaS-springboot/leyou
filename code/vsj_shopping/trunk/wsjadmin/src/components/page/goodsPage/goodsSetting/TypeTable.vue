    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="typeList" border class="table" ref="multipleTable">
                <el-table-column prop="ico" label="图标"  width="70px">
                    <template slot-scope="scope">
                        <div class="tableImg" :style="{backgroundImage: 'url(' + scope.row.ico + ')'}" @click="handlePictureCardPreview( scope.row.ico)"></div>
    　　　　　　　　  </template>
                </el-table-column>
                <el-table-column prop="categoryName" label="分类名称">
                </el-table-column>
                <el-table-column prop="categorySort" label="分类权重">
                </el-table-column>
                <el-table-column prop="categoryStatus" label="分类状态" >
                    <template slot-scope="scope">
    　　　　　　　　　    <span v-if="scope.row.categoryStatus=== 2">首页显示</span>
                        <span v-if="scope.row.categoryStatus=== 1">启用</span>
                        <span v-if="scope.row.categoryStatus=== 0">关闭</span>
    　　　　　　　　  </template>
                </el-table-column>
