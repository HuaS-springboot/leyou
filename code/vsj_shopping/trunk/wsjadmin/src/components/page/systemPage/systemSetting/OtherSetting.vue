            ...
            <div class="form-box">
                <el-form ref="mallsetting" :model="mallsetting" label-width="160px" label-position="left">
                    ...
                    <el-form-item label="AccessKeyId">
                        <el-input v-model="mallsetting.ali_dx_access_key_id"></el-input>
                    </el-form-item>
                    <el-form-item label="AccessKeySecret  ">
                        <el-input v-model="mallsetting.ali_dx_access_key_secret"></el-input>
                    </el-form-item>
                    <el-form-item label="短信签名">
                        <el-input v-model="mallsetting.ali_dx_sign"></el-input>
                    </el-form-item>
                    <el-form-item label="注册模板编号">
                        <el-input v-model="mallsetting.ali_dx_regist_template"></el-input>
                    </el-form-item>
                    <el-form-item label="找回密码模板编号">
                        <el-input v-model="mallsetting.ali_dx_find_template"></el-input>
                    </el-form-item>
                    <div class="titleTag">远程文件配置(图片存储)</div>
                    <el-form-item label="图片存储服务商" >
                         <el-select v-model="remote_files" placeholder="请选择">
                            <el-option
                            v-for="item in fileStorageApi"
                            :key="item.value"                            
                            :value="item.key">
                            </el-option>
                        </el-select>
